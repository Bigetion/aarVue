                ...
                <v-card flat>
                  <div class="mx-2">
                    <div class="mt-4">
                      ...
                      <multiselect class="mt-2" select-label="" deselect-label="" v-model="categories" :options="categoryList" :multiple="true" :close-on-select="false" :clear-on-select="false" :hide-selected="true" :preserve-search="true" placeholder="Choose categories" label="text"
                        track-by="id"></multiselect>
                    </div>
                    <div class="mt-4">
                      <label class="subheading pb-3">Tags</label>
                      <multiselect class="mt-2" select-label="" deselect-label="" v-model="tags" tag-placeholder="Add this as new tag" placeholder="Search or add a tag" label="text" track-by="id" :options="tagList" :multiple="true" :taggable="true" @tag="addTag" :close-on-select="false"
                        :clear-on-select="false" :hide-selected="true"></multiselect>
                    </div>
                  </div>
                </v-card>
              </v-flex>
